...
import gdAbi from '@gooddollar/goodcontracts/build/contracts/GoodDollar.json'
import ubiAbi from '@gooddollar/goodcontracts/stakingModel/build/contracts/UBIScheme.json'
  ...
  getTokenContract (provider) {
    if (!this.tokenContract) {
      ...
      this.tokenContract = new ethers.Contract(
        this.getContractAddress('protocol', 'GoodDollar'),
        gdAbi.abi,
        provider
      )
    }
