...
const ExternalLink: React.FC<{ label: string; url: string; dataAttr: string }> = ({ label, url, dataAttr }) => {
        ...
        <SideBarSC className="flex flex-col justify-between" $mobile={mobile}>
            <div className="sidebar-inner-container">
                ...
                <nav className="mt-5">
                    ...
                    <ExternalLink label={i18n._(t`Wallet`)} url="https://wallet.gooddollar.org/" dataAttr="wallet" />
                    <ExternalLink label={i18n._(t`Fuse Bridge`)} url="https://app.fuse.fi/#/bridge" dataAttr="bridge" />
                    <ExternalLink label={i18n._(t`Docs`)} url="https://docs.gooddollar.org" dataAttr="docs" />
                    <ExternalLink
