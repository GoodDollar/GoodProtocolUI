...
const torus_1 = __importDefault(require("@web3-onboard/torus"));
...
function torus(options) {
    const defaultTorus = (0, torus_1.default)(options);
    return () => {
        const walletInit = defaultTorus({ device: (0, utils_1.getDevice)() });
