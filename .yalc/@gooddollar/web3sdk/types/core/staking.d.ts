 ...
 */
export declare function approveStake(web3: Web3, protocol: LIQUIDITY_PROTOCOL, spender: string, amount: string, token: Token, onSent?: (transactionHash: string) => void): Promise<void>;
/**
...
export declare function promiseAll(transactions: any[], account: string, chainId: number, onSent?: (firstTransactionHash: string, from: string, chainId: number) => void, onReceipt?: () => void, onError?: (e: any) => void): Promise<any[]>;
/**
 * Claim GOOD rewards from staking.
 * @param {Web3} web3 Web3 instance.
 * @param {function} [onSent] calls when transactions sent to a blockchain
 */
export declare function claimGoodRewards(web3: Web3, onSent?: (firstTransactionHash: string, from: string, chainId: number) => void, onReceipt?: () => void, onError?: (e: any) => void): Promise<TransactionDetails[]>;
/**
 * Claim GOOD reward from a stake.
 * @param {Web3} web3 Web3 instance.
 * @param {function} [onSent] calls when transactions sent to a blockchain
 */
export declare function claimGoodReward(web3: Web3, contractAddress: string, onSent?: (firstTransactionHash: string, from: string, chainId: number) => void, onReceipt?: () => void, onError?: (e: any) => void): Promise<TransactionDetails[]>;
/**
 * Claim G$ rewards from staking.
 * @param {Web3} web3 Web3 instance.
 * @param {function} [onSent] calls when transactions sent to a blockchain
 */
export declare function claimG$Rewards(web3: Web3, onSent?: (firstTransactionHash: string, from: string, chainId: number) => void, onReceipt?: () => void, onError?: (e: any) => void): Promise<TransactionDetails[]>;
/**
 * Claim G$ reward from a stake.
 * @param {Web3} web3 Web3 instance.
 * @param {function} [onSent] calls when transactions sent to a blockchain
 */
export declare function claimG$Reward(web3: Web3, contractAddress: string, onSent?: (firstTransactionHash: string, from: string, chainId: number) => void, onReceipt?: () => void, onError?: (e: any) => void): Promise<TransactionDetails[]>;
export {};
